package com.thetimekeepers.timeit.calendar;
...
public class CalendarFragment extends Fragment implements WeekView.EventClickListener, MonthLoader.MonthChangeListener, WeekView.EventLongPressListener, WeekView.EmptyViewLongPressListener {
    ...
    public List<? extends WeekViewEvent> onMonthChange(int newYear, int newMonth) {
        ...
        WeekViewEvent event = new WeekViewEvent(1, "Eat a Krabby Patty", startTime, endTime);
        ...
        endTime.set(Calendar.MONTH, newMonth-1);
        event = new WeekViewEvent(10, "Present at CodePath Demo Day today!", startTime, endTime);
        ...
        endTime.set(Calendar.MINUTE, 00);
        endTime.set(Calendar.MONTH, newMonth-1);
        event = new WeekViewEvent(2, "Watch movie with friends", startTime, endTime);
        event.setColor(getResources().getColor(R.color.event_color_02));
        events.add(event);
        ...
        endTime.set(Calendar.MONTH, newMonth - 1);
        event = new WeekViewEvent(3, "Take a run", startTime, endTime);
        ...
        event = new WeekViewEvent(10, "Travel home for Christmas", startTime, endTime);
        event.setColor(getResources().getColor(R.color.event_color_03));
        events.add(event);
        ...
        event = new WeekViewEvent(4, "Go hang out at Southlake", startTime, endTime);
        ...
        endTime = (Calendar) startTime.clone();
        endTime.add(Calendar.HOUR_OF_DAY, 3);
        event = new WeekViewEvent(5, "Time to sleep", startTime, endTime);
        event.setColor(getResources().getColor(R.color.event_color_01));
        events.add(event);
        ...
        endTime = (Calendar) startTime.clone();
        endTime.add(Calendar.HOUR_OF_DAY, 3);
        event = new WeekViewEvent(5, "Time to eat", startTime, endTime);
        event.setColor(getResources().getColor(R.color.event_color_02));
        events.add(event);
